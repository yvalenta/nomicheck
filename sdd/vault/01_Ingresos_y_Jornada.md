...
*   **Trabajo en Domingo o Festivo:** El recargo **NO es un valor fijo**. Es una tabla progresiva que sube cada julio hasta llegar al 100% en 2027 (ver también el detalle en [[05_Valores_Actualizables]]):
    *   Hasta junio 2025: 75% extra (`x 1.75`)
    *   Julio 2025 a junio 2026: 80% extra (`x 1.80`)
    *   **Julio 2026 a junio 2027 (vigente hoy):** 90% extra (`x 1.90`)
    *   A partir de julio 2027: 100% extra (`x 2.00`)
