  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center rounded-md hover:bg-slate-100 transition-colors"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-mint text-white hover:bg-mint hover:text-white focus:bg-mint focus:text-white",
        day_today: "bg-slate-100 text-ink",
        day_outside:
          "day-outside text-muted opacity-50 aria-selected:bg-slate-100/50 aria-selected:text-muted aria-selected:opacity-30",
        day_disabled: "text-muted opacity-50",
        day_range_middle:
          "aria-selected:bg-slate-100 aria-selected:text-ink",
